...
今天学的是第一章基本概念，所以就做了个简单的思维导图：[NLP（自然语言处理）基础概念.pdf](/MyLearningBlog/admin/pdf/NLP（自然语言处理）基础概念.pdf)

附上图片：![NLP（自然语言处理）基础概念](/MyLearningBlog/admin/png/NLP（自然语言处理）基础概念.png)
